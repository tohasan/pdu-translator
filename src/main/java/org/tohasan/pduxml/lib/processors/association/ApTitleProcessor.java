...
public final class ApTitleProcessor extends org.tohasan.pduxml.lib.infra.c {
    public ApTitleProcessor(int tagKey, org.tohasan.pduxml.lib.infra.m var2) throws XmlPduException {
        this.tagKey = tagKey;
        var2.b(tagKey);
        this.a(var2);
        var2.a();
