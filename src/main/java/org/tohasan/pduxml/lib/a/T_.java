...
public final class T_ extends org.tohasan.pduxml.lib.infra.e {
   private int a;

   public T_(int var1, org.tohasan.pduxml.lib.infra.m var2) throws XmlPduException {
      this.b = 221;
      var2.b(221);
      byte[] var4;
   ...
   public T_(int var1, org.tohasan.pduxml.lib.infra.h var2) throws XmlPduException {
      this.b = 221;
      org.tohasan.pduxml.lib.infra.l var3;
