...
public class Misc {
   ...
   public static StringBuffer decodeBERBitStringHexStr(h var0) throws XmlPduException {
      StringBuffer var5 = new StringBuffer();
      int var1 = var0.a();
      int var2 = var0.a();
      --var1;
   ...
   public static StringBuffer decodeGraphicByteStringStr(h var0) throws XmlPduException {
      int var2 = var0.a();

      StringBuffer var3;
      for(var3 = new StringBuffer(); var2 > 0; --var2) {
         char var1 = (char)var0.a();
         var3.append(var1);
      }
   ...
   public static StringBuffer decodeObjectStr(h var0, boolean var1) throws XmlPduException {
      if(var1) {
         var0.a(6);
      }
   ...
   public static int decodeVarLengthUnsignedInteger(h var0) throws XmlPduException {
      int var1;
      if(((var1 = (byte)var0.a()) & 128) != 0) {
         switch(var1 & 127) {
         case 1:
            return var0.a();
         case 2:
            return (var0.a() << 8) + var0.a();
         default:
            throw new XmlPduException("Length " + String.valueOf(var1) + " of variable-length integer is not implemented");
         }
      } else {
         return var1;
      }
