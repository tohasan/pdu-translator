...
public final class aT_ extends org.tohasan.pduxml.lib.infra.e {
   private int a;

   public aT_(int var1, org.tohasan.pduxml.lib.infra.m var2) throws XmlPduException {
      this.b = var1;
      var2.b(var1);
      byte[] var4;
   ...
   public aT_(int var1, org.tohasan.pduxml.lib.infra.h var2) throws XmlPduException {
      this.b = var1;
      org.tohasan.pduxml.lib.infra.l var3;
