...
import org.tohasan.pduxml.lib.a.V_;
...
public final class GeneralBlockTransferProcessor extends MessageByteProcessor {
    ...
    public GeneralBlockTransferProcessor(int var1, org.tohasan.pduxml.lib.infra.m var2) throws XmlPduException {
        this.tagKey = 277;
        var2.c(277);
    ...
    public GeneralBlockTransferProcessor(int var1, MessageInputStream var2) throws XmlPduException {
        this.tagKey = 277;
        this.a = new V_(223, var2);
        this.c = new LongUnsignedProcessor(225, var2);
        this.d = new LongUnsignedProcessor(227, var2);
