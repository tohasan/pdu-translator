...
import org.tohasan.pduxml.lib.a.bT_;
...
public final class bg extends org.tohasan.pduxml.lib.infra.j {
   public bg(int var1, org.tohasan.pduxml.lib.infra.m var2) throws XmlPduException {
      ...
      while(var2.a == 1 && var1 < this.a.length) {
         this.a[var1++] = new bT_(149, var2);
      }

      var2.d(316);
   }

   public bg(int var1, org.tohasan.pduxml.lib.infra.h var2) throws XmlPduException {
      this.b = 316;
      var1 = Misc.decodeVarLengthUnsignedInteger(var2);
      this.a = new org.tohasan.pduxml.lib.infra.e[var1];

      for(int var3 = 0; var3 < var1; ++var3) {
         this.a[var3] = new bT_(149, var2);
      }
