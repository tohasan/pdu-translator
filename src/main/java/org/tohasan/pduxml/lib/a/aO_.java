...
public final class aO_ extends org.tohasan.pduxml.lib.infra.e {
   private bs a;
   private X_ c;
   private aT_ d;
   private ce e;
   ...
   public aO_(int var1, org.tohasan.pduxml.lib.infra.h var2) throws XmlPduException {
      this.b = 303;
      if(var2.a() != 0) {
         this.a = new bs(264, var2);
      }
