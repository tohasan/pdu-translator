...
public final class aZ_ extends MessageItemsProcessor {
    public aZ_(org.tohasan.pduxml.lib.infra.m var2) throws XmlPduException {
        this.tagKey = 181;
        var2.b(181);
        int var1 = var2.e(381);
    ...
    public aZ_(MessageInputStream messageInputStream) throws XmlPduException {
        this.tagKey = 181;
        int var1 = CommonUtils.decodeVarLengthUnsignedInteger(messageInputStream);
        this.items = new MessageByteProcessor[var1];

        for (int var3 = 0; var3 < var1; ++var3) {
            this.items[var3] = new o(14, messageInputStream);
        }
    }
